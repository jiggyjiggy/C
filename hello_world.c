...
'%s' 라는 format specifier(서식문자)로 문자열이 들어가 위치를 알려줌 (문자열 string)
...
quiz
1.
Q. 함수 선언시 매개변수에 void를 사용하는 것은 무엇을 의미
void print_number(void)

A. 이 함수는 매개 변수가 없다

2. 
Q. 함수 선언시 매개변수에 void를 사용하지 않는 것은 무엇을 의미
void print_number()

A. 이 함수는 매개변수를 받는다. 단지 아직 매개변수의 갯수와 자료형을 모를뿐이다

3. 
Q. C89 표준에서 허용하는 주석 형태는?
